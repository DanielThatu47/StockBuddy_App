...
public class DemoTradingAccount {
	...
	public void setDayChangePercentage(double dayChangePercentage) { this.dayChangePercentage = dayChangePercentage; }
	public double getWeekChange() { return weekChange; }
	public void setWeekChange(double weekChange) { this.weekChange = weekChange; }
	public double getWeekChangePercentage() { return weekChangePercentage; }
	public void setWeekChangePercentage(double weekChangePercentage) { this.weekChangePercentage = weekChangePercentage; }
	public double getMonthChange() { return monthChange; }
	public void setMonthChange(double monthChange) { this.monthChange = monthChange; }
	public double getMonthChangePercentage() { return monthChangePercentage; }
	public void setMonthChangePercentage(double monthChangePercentage) { this.monthChangePercentage = monthChangePercentage; }
	public double getYearChange() { return yearChange; }
	public void setYearChange(double yearChange) { this.yearChange = yearChange; }
	public double getYearChangePercentage() { return yearChangePercentage; }
	public void setYearChangePercentage(double yearChangePercentage) { this.yearChangePercentage = yearChangePercentage; }
	...
	public void recalculate() {
		double holdingsValue = money(holdings.stream()
